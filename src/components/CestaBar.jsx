      ...
      >
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          <button
            ...
            style={{
              flex: '0 0 auto', padding: '11px 20px', borderRadius: 100,
              border: '1px solid rgba(0,0,0,0.14)', background: '#fff',
              fontSize: 13.5, fontWeight: 600, cursor: 'pointer', color: '#6E6E73',
            }}
          ...
          <button
            onClick={handleSend}
            style={{
              flex: '1 1 200px', padding: '13px 20px', borderRadius: 100,
