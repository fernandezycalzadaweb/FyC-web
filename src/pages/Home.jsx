  ...
  return (
    <>
      ...
      <header style={{ padding: '88px 0 0', textAlign: 'center' }}>
        <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 24px' }}>
          ...
          <h1
            style={{
              ...
              margin: '0 auto 14px', maxWidth: '15ch',
            }}
          >
            Del vivero a tu{' '}
            <span style={{ color: '#4A7A34' }}>floristería.</span>
          </h1>
          <p style={{ fontSize: 18, color: '#6E6E73', maxWidth: '34ch', margin: '0 auto 32px' }}>
        ...
        {/* Foto hero */}
        <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 24px' }}>
          <div style={{ borderRadius: 28, overflow: 'hidden', position: 'relative', boxShadow: '0 30px 60px -30px rgba(0,0,0,0.25)' }}>
            <img
      ...
      <section style={{ padding: '72px 0', borderBottom: '1px solid rgba(0,0,0,0.08)' }}>
        <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 32, textAlign: 'center' }}>
          {[
            ...
            <div key={label}>
              <div style={{ fontSize: 'clamp(36px, 5vw, 56px)', fontWeight: 800, letterSpacing: '-0.02em', color: '#1D1D1F' }}>
                {num}
              </div>
      ...
      <section style={{ padding: '88px 0', borderTop: '1px solid rgba(0,0,0,0.08)' }}>
        <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 24px' }}>
          <div style={{ textAlign: 'center', maxWidth: 600, margin: '0 auto 40px' }}>
            <h2 style={{ fontSize: 'clamp(28px,4vw,42px)', fontWeight: 800, letterSpacing: '-0.02em', margin: '0 0 10px' }}>
              El catálogo
            </h2>
